...
<section class="card form-card">
    <div class="card-header">
        <div>
            ...
            <p>Field bertanda wajib harus diisi dengan data yang valid.</p>
        </div>
    </div>
    <div class="card-body padded-card-body">
        <form method="post" action="<?= esc($action) ?>" enctype="multipart/form-data" class="form-stack" novalidate>
            <?= csrf_field() ?>
            ...
            <div class="form-grid">
                ...
                <div class="form-group">
                    ...
                    <input
                        ...
                        aria-describedby="<?= isset($errors['image']) ? 'image-error' : '' ?>"
                    >
